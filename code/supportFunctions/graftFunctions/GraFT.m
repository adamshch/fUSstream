...
corr_kern = checkCorrKern(data_obj, corr_kern, params.verbose);            % Check spatial smoothing kernel 引入相邻像素影响的矩阵，用于空间卷积
...
dict_out = dictInitialize(dict_init, T, N);                                % Make sure dictionary is initialized correctly 每一列都归一化的初始字典
